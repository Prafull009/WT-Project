  ...
  return (
    <div> 
      ...
      <div className="flex flex-col items-center">
        <form className="w-full lg:w-2/3 border border-solid border-gray-700 p-6 mt-10" onSubmit={onSubmit}>
          <h1 className="text-lg font-bold text-center">Upload Research Paper</h1>
          <input
            type="text"
          ...
          />
          <button className="bg-green-600 w-20 text-white rounded-md font-bold p-2 text-center" type="submit">
            Upload
          </button>
        </form>
        ...
        {/* {allPdfs && allPdfs.map((data, index) => (
          <div className="border border-solid border-gray-700 p-4 my-4" key={index}>
            ...
            <button className="bg-green-600 text-white rounded-md p-2 text-center mt-2" onClick={() => showPdf(data.pdf)}>
              Show PDF
            </button>
          </div>
        ))} */}
